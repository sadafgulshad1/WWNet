...
from .layers.local_elastic_conv import DistConv_H_H, DistConv_Z2_H, DistConv_H_H_1x1, project
...
def resnet_local_elastic_18(num_classes=10, num_elastic_blocks=0, basis_num_displacements=4, basis_scale=0.9, basis_alpha=1,**kwargs):
    ...
    return model
def resnet_local_elastic_34(num_classes=10, num_elastic_blocks=0, num_displacements=4, scale=0.9, alpha=1):
    model = _partial_elastic_resnet('basic', num_elastic_blocks=num_elastic_blocks,
...
def resnet_local_elastic_50(num_classes=10, num_elastic_blocks=0, num_displacements=4, scale=0.9, alpha=1):
...
def resnet_local_elastic_101(num_classes=10, num_elastic_blocks=0, num_displacements=4, scale=0.9, alpha=1):
    model = _partial_elastic_resnet('bottleneck', num_elastic_blocks=num_elastic_blocks,
...
def resnet_local_elastic_152(num_classes=10, num_elastic_blocks=0, basis_num_displacements=4, basis_scale=0.9, basis_alpha=1,**kwargs):
    model = _partial_elastic_resnet('bottleneck', num_elastic_blocks=num_elastic_blocks,
